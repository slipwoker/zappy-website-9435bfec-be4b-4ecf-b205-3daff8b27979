    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        setTimeout(function() {
          ...
          validInputs.forEach(function(input) { input.classList.remove('valid'); });
          if (submitBtn) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9435bfec-be4b-4ecf-b205-3daff8b27979',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9435bfec-be4b-4ecf-b205-3daff8b27979';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9435bfec-be4b-4ecf-b205-3daff8b27979';
